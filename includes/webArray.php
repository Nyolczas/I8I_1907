...
$webArr = [
    ...
    [
        'name' => ['optowit'],
        'isImage' => false, 
        'path' => 'https://optowit.hu/',
        'title' => 'Optowit webáruház',
        'desc' => 'sitebuild, frontend fejlesztés'
    ],
    [
        'name' => ['hr-evolution'],
        'isImage' => false, 
        'path' => 'https://hrevolution.hu/munkavallalo-tamogato-program/',
        'title' => 'HR Evolution',
        'desc' => 'sitebuild, frontend fejlesztés'
    ],
    [
    ...
    [
        ...
        'title' => 'Kockajáték',
        'desc' => 'Javascript - két személyes dobókocka játék'
    ]
];
